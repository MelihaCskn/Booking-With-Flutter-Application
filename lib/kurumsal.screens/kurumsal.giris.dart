...
class KurumsalGiris extends StatefulWidget {
  const KurumsalGiris({super.key});

  @override
  State<KurumsalGiris> createState() => _KurumsalGirisState();
}

class _KurumsalGirisState extends State<KurumsalGiris> {
  String secilitext = "";
  String email = "", sifre = "";
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          if (formkey.currentState!.validate()) {
                            ...
                            AuthServices()
                                .KurumsalGirisYap(context, email: email, password: sifre);
                          } else {}
                        },
