...
import '../screens/ilksayfa.dart';

class BireyselMenu extends StatefulWidget{
  @override
  State<BireyselMenu> createState() => _BireyselMenuState();
}

class _BireyselMenuState extends State<BireyselMenu> {
